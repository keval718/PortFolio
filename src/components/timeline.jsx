                ...
                <div className="timeline-centered">
                  ...
                  <article className="timeline-entry animate-box" data-animate-effect="fadeInTop">
                    <div className="timeline-entry-inner">
                      ...
                      <div className="timeline-label">
                        <h2>Humber College <span>2018-2020</span></h2>
                        <p>I persuade my post graduation degree in Information and Technology Solutions. I have taken courses like Web Development, Object Oriented Programming, SQL Server database Development,
                          Web Programming and Designing, C#, .NET, Big Data, React, NodeJS
                        </p>
                      </div>
                    </div>
                  </article>
                  <article className="timeline-entry animate-box" data-animate-effect="fadeInLeft">
                    <div className="timeline-entry-inner">
                      ...
                      <div className="timeline-label">
                        <h2>Ks School of business management  <span>2015-2018</span></h2>
                        <p>I have completed my Bachelor’s in Computer Application and Information Technology. I have taken courses like - C, C++, Advance Java  , Data Structures and Algorithms, C#, .NET web development, Data Science</p> 
                      </div>
                    </div>
                  </article>
